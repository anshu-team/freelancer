...
if (isset($_POST["submit"])) 
{
  if (count($_POST["ids"]) > 0 )
  {
    ...
    $sql =mysqli_query($con,"DELETE FROM tbl_contact WHERE cid in ($all)");
    if($sql) 
    {
                      ...
                      <tbody>
                        ...
                        while($crow=mysqli_fetch_array($cres))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-danger btn-md" href="contact_delete?id=<?php echo urlencode(base64_encode($cid)); ?>" onclick="javascript:return confirm('Are u sure want to delete?');">
