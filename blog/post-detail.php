...
if(isset($_REQUEST['btn-comment']))
{
    ...
    if(isset($_REQUEST['chk']))
    {
       if(($name != NULL) && ($email != NULL) && ($website != NULL))
       {
        ...
        setcookie("Website", $website , time() + 36000);
       }
    }
    ...
    $mail->setFrom($email);
    $mail->isHTML(true);
    $mail->Body = "Name :" .$name . "<br>Website :" .$website . "<br><br><h4>" .$comment . "</h4>";
                                    ...
                                    <div class="comment-author vcard">
                                        <img alt=""
                                            ...
                                            loading="lazy"> <b class="fn"><a
                                                ...
                                                class="url"><?php echo $croww['name']; ?></a></b>
                    ...
                    <div id="respond" class="comment-respond">
                        ...
                        <form method="post" class="comment-form">
                            ...
                            <p class="comment-form-author">
                                ...
                                <input id="name" name="name" type="text" size="30" required="required" value="<?php if(isset($_COOKIE['Name'])){ echo $_COOKIE['Name']; } ?>">
                            </p>
                            <p class="comment-form-email">
                                <label for="email">Email <span class="required">*</span></label>
                                <input id="email" name="email" type="email" size="30"
                                    aria-describedby="email-notes" required="required" value="<?php if(isset($_COOKIE['Email'])){ echo $_COOKIE['Email']; } ?>">
                            </p>
                            <p class="comment-form-url">
                                <label for="url">Website</label>
                                <input id="website" name="website" type="url" size="30" required="" value="<?php if(isset($_COOKIE['Website'])){ echo $_COOKIE['Website']; } ?>">
                            </p>
                            <p class="comment-form-cookies-consent">
                                <input id="wp-comment-cookies-consent" name="chk"
                                    type="checkbox">
    ...
    <div class="columns small-12 medium-4">
        ...
        ?>
                ...
                <script type="text/javascript">
                    ...
                    var table = jQuery('#primary').dataTable({          
                             "bProcessing": true,
                             "sAjaxSource": "pagination_data",
                             "bPaginate":true,
