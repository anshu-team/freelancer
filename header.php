<header id="masthead" class="site-header">
    <div class="site-header-inner">
        ...
        <nav id="site-navigation" class="main-navigation">
            <button onclick="showmenu()" aria-label=" Menu toggle" class="menu-toggle" aria-controls="primary-menu"
                aria-expanded="false">
                <i class="fa fa-reorder"></i>
            </button>
            <div class="menu-primary-container" id="myUl">
                <div class="menu-main-menu-container">
                    <ul id="primary-menu" class="menu">
                        <li id="menu-item-26"
                            ...
                            <a href="http://localhost/freelancer/" aria-current="page">Home</a>
                        </li>
                        <li id="menu-item-27"
                            ...
                            <ul class="sub-menu">
                                <li id="menu-item-91"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-91"><a
                                        href="http://www.jamesclifton.com/category/comics/">Comics</a></li>
                                <li id="menu-item-66"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-66"><a
                                        href="http://www.jamesclifton.com/category/ebay/">Ebay</a></li>
                                <li id="menu-item-98"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-98"><a
                                        href="http://www.jamesclifton.com/category/game-design/">Game Design</a></li>
                                <li id="menu-item-92"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-92"><a
                                        href="http://www.jamesclifton.com/category/google/">Google</a></li>
                                <li id="menu-item-61"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-61"><a
                                        href="http://www.jamesclifton.com/category/other/">Other</a></li>
                            </ul>
                        </li>
                        <!-- <li id="menu-item-27"
                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-27">
